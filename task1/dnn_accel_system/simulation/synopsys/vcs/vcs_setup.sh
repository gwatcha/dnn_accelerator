...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v -ntb_opts dtm $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS \
  ...
  $QSYS_SIMDIR/submodules/dnn_accel_system_mm_interconnect_0_rsp_mux_001.sv \
  $QSYS_SIMDIR/submodules/dnn_accel_system_mm_interconnect_0_rsp_mux.sv \
  $QSYS_SIMDIR/submodules/dnn_accel_system_mm_interconnect_0_rsp_demux.sv \
  $QSYS_SIMDIR/submodules/dnn_accel_system_mm_interconnect_0_cmd_mux_002.sv \
  ...
  $QSYS_SIMDIR/submodules/dnn_accel_system_mm_interconnect_0_cmd_demux_001.sv \
  ...
  $QSYS_SIMDIR/submodules/dnn_accel_system_mm_interconnect_0_router_001.sv \
  ...
  $QSYS_SIMDIR/submodules/sdram_master.sv \
