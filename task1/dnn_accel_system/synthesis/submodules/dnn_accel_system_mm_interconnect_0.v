...
module dnn_accel_system_mm_interconnect_0 (
		...
		input  wire        mem_cpy_accel_0_reset_reset_bridge_in_reset_reset, // mem_cpy_accel_0_reset_reset_bridge_in_reset.reset
	...
	wire          rsp_mux_src_valid;                                                                  // rsp_mux:src_valid -> mem_cpy_accel_0_avalon_master_agent:rp_valid
	wire  [107:0] rsp_mux_src_data;                                                                   // rsp_mux:src_data -> mem_cpy_accel_0_avalon_master_agent:rp_data
	wire          rsp_mux_src_ready;                                                                  // mem_cpy_accel_0_avalon_master_agent:rp_ready -> rsp_mux:src_ready
	wire    [4:0] rsp_mux_src_channel;                                                                // rsp_mux:src_channel -> mem_cpy_accel_0_avalon_master_agent:rp_channel
	wire          rsp_mux_src_startofpacket;                                                          // rsp_mux:src_startofpacket -> mem_cpy_accel_0_avalon_master_agent:rp_startofpacket
	wire          rsp_mux_src_endofpacket;                                                            // rsp_mux:src_endofpacket -> mem_cpy_accel_0_avalon_master_agent:rp_endofpacket
	...
	wire          cmd_mux_004_src_valid;                                                              // cmd_mux_004:src_valid -> mem_cpy_accel_0_slave_agent:cp_valid
	wire  [107:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> mem_cpy_accel_0_slave_agent:cp_data
	wire          cmd_mux_004_src_ready;                                                              // mem_cpy_accel_0_slave_agent:cp_ready -> cmd_mux_004:src_ready
	wire    [4:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> mem_cpy_accel_0_slave_agent:cp_channel
	wire          cmd_mux_004_src_startofpacket;                                                      // cmd_mux_004:src_startofpacket -> mem_cpy_accel_0_slave_agent:cp_startofpacket
	wire          cmd_mux_004_src_endofpacket;                                                        // cmd_mux_004:src_endofpacket -> mem_cpy_accel_0_slave_agent:cp_endofpacket
	wire          mem_cpy_accel_0_avalon_master_agent_cp_valid;                                       // mem_cpy_accel_0_avalon_master_agent:cp_valid -> router:sink_valid
	wire  [107:0] mem_cpy_accel_0_avalon_master_agent_cp_data;                                        // mem_cpy_accel_0_avalon_master_agent:cp_data -> router:sink_data
	wire          mem_cpy_accel_0_avalon_master_agent_cp_ready;                                       // router:sink_ready -> mem_cpy_accel_0_avalon_master_agent:cp_ready
	wire          mem_cpy_accel_0_avalon_master_agent_cp_startofpacket;                               // mem_cpy_accel_0_avalon_master_agent:cp_startofpacket -> router:sink_startofpacket
	wire          mem_cpy_accel_0_avalon_master_agent_cp_endofpacket;                                 // mem_cpy_accel_0_avalon_master_agent:cp_endofpacket -> router:sink_endofpacket
	...
	wire  [107:0] pio_0_s1_agent_rp_data;                                                             // pio_0_s1_agent:rp_data -> router_006:sink_data
	...
	wire          mem_cpy_accel_0_slave_agent_rp_valid;                                               // mem_cpy_accel_0_slave_agent:rp_valid -> router_007:sink_valid
	wire  [107:0] mem_cpy_accel_0_slave_agent_rp_data;                                                // mem_cpy_accel_0_slave_agent:rp_data -> router_007:sink_data
	wire          mem_cpy_accel_0_slave_agent_rp_ready;                                               // router_007:sink_ready -> mem_cpy_accel_0_slave_agent:rp_ready
	wire          mem_cpy_accel_0_slave_agent_rp_startofpacket;                                       // mem_cpy_accel_0_slave_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire          mem_cpy_accel_0_slave_agent_rp_endofpacket;                                         // mem_cpy_accel_0_slave_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire   [89:0] router_003_src_data;                                                                // router_003:src_data -> new_sdram_controller_0_s1_rsp_width_adapter:in_data
	wire          router_003_src_ready;                                                               // new_sdram_controller_0_s1_rsp_width_adapter:in_ready -> router_003:src_ready
	wire    [4:0] router_003_src_channel;                                                             // router_003:src_channel -> new_sdram_controller_0_s1_rsp_width_adapter:in_channel
	...
	wire    [4:0] new_sdram_controller_0_s1_rsp_width_adapter_src_channel;                            // new_sdram_controller_0_s1_rsp_width_adapter:out_channel -> rsp_demux:sink_channel
	...
	wire    [4:0] cmd_mux_src_channel;                                                                // cmd_mux:src_channel -> new_sdram_controller_0_s1_cmd_width_adapter:in_channel
	...
	wire          mem_cpy_accel_0_slave_agent_rdata_fifo_src_valid;                                   // mem_cpy_accel_0_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire   [33:0] mem_cpy_accel_0_slave_agent_rdata_fifo_src_data;                                    // mem_cpy_accel_0_slave_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire          mem_cpy_accel_0_slave_agent_rdata_fifo_src_ready;                                   // avalon_st_adapter_004:in_0_ready -> mem_cpy_accel_0_slave_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_004_out_0_valid;                                                  // avalon_st_adapter_004:out_0_valid -> mem_cpy_accel_0_slave_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_004_out_0_data;                                                   // avalon_st_adapter_004:out_0_data -> mem_cpy_accel_0_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_004_out_0_ready;                                                  // mem_cpy_accel_0_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire    [0:0] avalon_st_adapter_004_out_0_error;                                                  // avalon_st_adapter_004:out_0_error -> mem_cpy_accel_0_slave_agent:rdata_fifo_sink_error
	...
	altera_merlin_master_translator #(
		...
		.reset                  (mem_cpy_accel_0_reset_reset_bridge_in_reset_reset),                                //                     reset.reset
	...
	altera_merlin_master_agent #(
		...
		.clk                   (pll_0_outclk0_clk),                                                                //       clk.clk
		.reset                 (mem_cpy_accel_0_reset_reset_bridge_in_reset_reset),                                // clk_reset.reset
	...
	dnn_accel_system_mm_interconnect_0_router_005 router_007 (
	...
	altera_merlin_burst_adapter #(
		...
		.reset                 (mem_cpy_accel_0_reset_reset_bridge_in_reset_reset),             // cr0_reset.reset
	...
	dnn_accel_system_mm_interconnect_0_cmd_demux_002 rsp_demux_001 (
		.clk                (pll_0_outclk0_clk),                                 //       clk.clk
		.reset              (mem_cpy_accel_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	dnn_accel_system_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_rst_0_reset (mem_cpy_accel_0_reset_reset_bridge_in_reset_reset),    // in_rst_0.reset
