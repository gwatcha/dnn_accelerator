...
module dnn_accel_system_mm_interconnect_0 (
	...
	wire  [101:0] cmd_mux_002_src_data;                                                               // cmd_mux_002:src_data -> pio_0_s1_agent:cp_data
	...
	wire  [101:0] pio_0_s1_agent_rp_data;                                                             // pio_0_s1_agent:rp_data -> router_004:sink_data
	...
	wire   [83:0] new_sdram_controller_0_s1_agent_rp_data;                                            // new_sdram_controller_0_s1_agent:rp_data -> router_005:sink_data
	...
	wire   [83:0] router_005_src_data;                                                                // router_005:src_data -> new_sdram_controller_0_s1_rsp_width_adapter:in_data
	...
	wire  [101:0] new_sdram_controller_0_s1_rsp_width_adapter_src_data;                               // new_sdram_controller_0_s1_rsp_width_adapter:out_data -> rsp_demux_003:sink_data
	...
	wire  [101:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> new_sdram_controller_0_s1_cmd_width_adapter:in_data
	...
	dnn_accel_system_mm_interconnect_0_router_002 router_004 (
	...
	dnn_accel_system_mm_interconnect_0_cmd_mux_001 cmd_mux_003 (
		.clk                 (pll_0_outclk0_clk),                       //       clk.clk
		.reset               (pio_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	dnn_accel_system_mm_interconnect_0_avalon_st_adapter_003 #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),
